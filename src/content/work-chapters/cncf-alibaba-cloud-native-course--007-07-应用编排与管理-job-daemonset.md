...
description: "07 应用编排与管理：Job & DaemonSet Job 需求来源 Job 背景问题 首先我们来看一下 Job 的需求来源。我们知道 K8s 里面，最小的调度单元是 Pod，我们可以直接通过 Pod 来运行任务进程。这样做将会产生以下几种问题： 我们如何保证 Pod 内进程正确的结束？ 如何保证进程运行失败后重试？ 如何管理多个任务，且任务之间有依赖关系"
sourceUrl: "https://study.disign.me/document/CNCF%20X%20%e9%98%bf%e9%87%8c%e5%b7%b4%e5%b7%b4%e4%ba%91%e5%8e%9f%e7%94%9f%e6%8a%80%e6%9c%af%e5%85%ac%e5%bc%80%e8%af%be/07%20%e5%ba%94%e7%94%a8%e7%bc%96%e6%8e%92%e4%b8%8e%e7%ae%a1%e7%90%86%ef%bc%9aJob%20&%20DaemonSet.md"
workSlug: "cncf-alibaba-cloud-native-course"
workTitle: "CNCF X 阿里巴巴云原生技术公开课"
chapterSlug: "007-07-应用编排与管理-job-daemonset"
order: 7
categories: ["云原生", "CNCF"]
...
<p><img src="https://study-cdn.disign.me/images/20250215/e6af92fe265ddefb3fafdfa88956f83d.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/16aea44f81bf31cac8543d20f2269a44.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/f23963fae43ad469e5eb48e393ec667a.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/8b9b16225138dcf0f138cff04a3038e9.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/3eb4789bae935d3eedd466e1172f61c2.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/651add1188f956041cb93f9efc436b26.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/4f58b9555abd15bc43c34724a177ce7f.webp" alt="avatar"></p>

<h4 id="并行-job-的编排文件">并行 Job 的编排文件</h4>

<p>下面再来看第二个例子：</p>

<p><img src="https://study-cdn.disign.me/images/20250215/bcb312e2a55267716ee3a6889c808796.webp" alt="avatar"></p>

<h4 id="并行-job-的创建及运行验证">并行 Job 的创建及运行验证</h4>

<p>这个例子就是指刚才的并行运行 Job 创建之后，可以看到有第二个并行的 Job。</p>

<p><img src="https://study-cdn.disign.me/images/20250215/58ccb7ceebd018dafe8ef886970781e8.webp" alt="avatar"></p>

<p>现在已经有两个 Pod 正在 running，可以看到它大概执行了快到 30s</p>

<p><img src="https://study-cdn.disign.me/images/20250215/60245ed8e7d4dc123a2f77050ea86f34.webp" alt="avatar"></p>

<p>30s 之后它应该会起第二个。</p>

<p><img src="https://study-cdn.disign.me/images/20250215/64f7e54cc2862afd2845de5c1175804a.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/2777c2a6b6b20dc300ca459b7e605d83.webp" alt="avatar"></p>

<h4 id="cronjob-的编排文件">Cronjob 的编排文件</h4>

<p>下面来看第三个例子 —— CronJob。 CronJob 是每分钟执行一次，每次一个 job。</p>

<p><img src="https://study-cdn.disign.me/images/20250215/31d0560e4012e79eb1b20aa2a8dd5ee3.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/111cb56c80371a2668cb4d8ed8baf876.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/40c426bd669a16d513b341017fcdf727.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/9cb8b915a66564e86bce3c033aa1b7d9.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/09bbcba24331f48001731b9e949e8e96.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/299416962940222c72f876c3906d899b.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/6c0255b0bfd33f839bb329f7d21e35bc.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/86db9eb0cb58019cda3b1a4e02f8c97f.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/30cdd7d38997b02d1552df2d5d491c2d.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/f88757a1bb6b8837fd36bafd7fe7b2c0.webp" alt="avatar"></p>

<p>从下图中可以看到，一共有 4 个 pod 被创建出来。为什么是 4 个 pod呢？因为只有 4 个节点，所以每个节点上都会运行一个对应的 pod。</p>

<p><img src="https://study-cdn.disign.me/images/20250215/a611d31b5ae462c7c3a0965e391bf87e.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/a49f77a4bc96b6eeef7b1c577ad0e91c.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/89a889a3a749cb390b44240aae682243.webp" alt="avatar"></p>
...
<p><img src="https://study-cdn.disign.me/images/20250215/edc98e1f23a5b10fe2335b5d4782c85d.webp" alt="avatar"></p>
